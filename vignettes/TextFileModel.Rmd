...
Now define calibration data (synthetic data here). The data frame `twoPopulations` comes with the `RBaM` package. 
...
Play with predictions: what would happen with a warming of +2 degree? 
...
Plot spaghetti results for P2 for instance (gray), and compare with population associated with original temperature series (red). 
